...
class News extends Component {
  ...
  updateNews=async()=>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=72f49f13dbf64e11983513852b5a7b27&page=${this.state.page}&pageSize=${this.props.pageSize}`
